...
if (!class_exists('SLPJanitor_Admin')) {
    ...
    class SLPJanitor_Admin extends SLP_BaseClass_Admin {
        ...
        private $product_info = array(
            ...
            '-- Contact Extender'           => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-contact-extender/'         ),
            '-- Directory  Builder'         => array( 'product_url' => 'https://www.storelocatorplus.com/product/directory-builder/'             ),
            '-- Enhanced Map'               => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-enhanced-map/'             ),
            '-- Enhanced Results'           => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-enhanced-results/'         ),
            '-- Enhanced Search'            => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-enhanced-search/'          ),
	        ...
	        '-- Multi Map'                  => array( 'product_url' => 'https://www.storelocatorplus.com/product/multi-map/'                     ),
            ...
            '-- Pro Pack'                   => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-pro/'                      ),
            '-- Social Media Extender'      => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-social-media-extender/'    ),
            '-- Pages'                      => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-store-pages/'              ),
            '-- Tagalong'                   => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-tagalong/'                 ),
            '-- User Managed Locations'     => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-user-managed-locations/'   ),
            '-- Widget Pack'                => array( 'product_url' => 'https://www.storelocatorplus.com/product/slp4-widgets/'                  ),
        );
        ...
        private function add_settings_subtab() {
            ...
            $reset_message = __('Reset ALL of the options listed below to blank?', 'slp-janitor');
            $this->add_button(
                __('Reset SLP Options', 'slp-janitor'),
                "AdminUI.doAction('reset_options' ,'{$reset_message}','slp_janitor','action');"
            );
            ...
            $reset_message = __('Clear the Plugin Style cache?', 'slp-janitor');
            $this->add_button(
                __('Clear Plugin Style Cache', 'slp-janitor'),
                "AdminUI.doAction('clear_plugin_styles' ,'{$reset_message}','slp_janitor','action');"
            );
        ...
        private function add_tools_subtab() {
            ...
            $clear_message = __('Clear ALL of the locations of Store Locator Plus?', 'slp-janitor');
            $this->add_button(
                __('Clear Locations', 'slp-janitor') ,
                "AdminUI.doAction('clear_locations' , '{$clear_message}' ,'slp_janitor','action');"
            );
            $this->add_sublabel(
                __('Drop', 'slp-janitor'),
            ...
            $clear_message = __('Clear ALL of the locations of Store Locator Plus?', 'slp-janitor');
            $this->add_button(
                __('Drop Locations Table', 'slp-janitor'),
                "AdminUI.doAction('drop_locations_table' ,'{$clear_message}','slp_janitor','action');"
            );
            ...
            $reset_message = __('Are you sure you convert all encoded HTML to standard HTML in the location descriptions?', 'slp-janitor');
            $this->add_button(
                __('Fix Description HTML', 'slp-janitor'),
                "AdminUI.doAction('fix_descriptions' ,'{$reset_message}','slp_janitor','action');"
            );
            ...
            $reset_message = __('Are you sure you want to rebuild the extended data info?', 'slp-janitor');
            $this->add_button(
                __('Rebuild Extended Data Tables', 'slp-janitor'),
                "AdminUI.doAction('rebuild_extended_tables' ,'{$reset_message}','slp_janitor','action');"
            );
            $reset_message = __('Are you sure you want to delete all extended data info?', 'slp-janitor');
            $this->add_button(
                __('Delete Extended Data Tables', 'slp-janitor'),
                "AdminUI.doAction('delete_extend_datas' ,'{$reset_message}','slp_janitor','action');"
            );
            ...
            $reset_message = __('Are you sure you want to delete the Tagalong category helper table?', 'slp-janitor');
            $this->add_button(
                __('Delete Tagalong Category Helper Data', 'slp-janitor'),
                "AdminUI.doAction('delete_tagalong_helpers' ,'{$reset_message}','slp_janitor','action');"
            );
            $reset_message = __('Attempt to re-attach Tagalong categories?', 'slp-janitor');
            $this->add_button(
                __('Rebuild Tagalong Category Helper Data', 'slp-janitor'),
                "AdminUI.doAction('rebuild_tagalong_helpers' ,'{$reset_message}','slp_janitor','action');"
            );
        }
	     ...
	     */
	    public function add_button( $label, $on_click ) {
